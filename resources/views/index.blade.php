        ...
        <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="" class="flex items-center">
                        <span
                            class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">SunuEvent</span>
                    </a>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a
                        href="" class="hover:underline">SunuEvent</a>. All Rights Reserved.
                </span>
...
<style>
    * {
    ...
    /* Ajustement pour s'assurer que le carousel utilise la taille du parent */
    .slideshow-container img {
      width: 100%;
      height: auto; /* Pour s'assurer que l'image ne déforme pas */
    }
